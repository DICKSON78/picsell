...
class _CreditsScreenState extends State<CreditsScreen> {
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                credits == 0
                                    ? (isSwahili
                                        ? 'Salio limeisha — $rateText'
                                        : 'Balance empty — $rateText')
                                    : rateText,
                                style: GoogleFonts.poppins(
                                  fontSize: 12,
                                  fontWeight: FontWeight.w500,
    ...
    try {
      ...
      if (canUseBiometric) {
        final isAuthenticated = await biometricService.authenticate(
          reason: isSwahili
              ? 'Thibitisha malipo kwa biometric'
              : 'Authenticate payment with biometric',
          biometricOnly: false,
          stickyAuth: true,
        );
  ...
  void _showClickPesaBottomSheet(int credits, int price) {
    final localization =
        Provider.of<LocalizationProvider>(context, listen: false);
    final isSwahili = localization.isSwahili;
          ...
          children: [
            ...
            TextFormField(
              ...
              validator: (value) {
                if (value == null || value.isEmpty) {
                  return isSwahili
                      ? 'Namba ya akaunti inahitajika'
                      : 'Account number is required';
                }
                if (!RegExp(r'^\d{10}$').hasMatch(value)) {
                  return isSwahili
                      ? 'Namba ya akaunti lazima kuwa tarakimu 10'
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 8),
                      Text(
                        '${widget.credits} ${widget.localization.tr('credits')}',
                        style: GoogleFonts.poppins(
                          fontSize: 14,
                          fontWeight: FontWeight.w600,
                          color: AppTheme.primaryColor,
                      ...
                      const SizedBox(width: 12),
                      Text(
                        'TZS ${_formatPrice(widget.price.toDouble())}',
                        style: GoogleFonts.poppins(
                          fontSize: 14,
                          fontWeight: FontWeight.bold,
                          color: AppTheme.primaryColor,
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  const Divider(height: 16),
                  _row(isSwahili ? 'Kiasi' : 'Amount',
                      'TZS ${_formatPrice(price.toInt())}'),
                  const Divider(height: 16),
